...
const AddContent = () => {
  ...
  //     e.preventDefault();
  //     dispatch(addFeedback({ name, email, date, title, description, file }));
  //     setName("");
  //     setEmail("");
  //     setDate("");
  //     setTitle("");
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(addFeedback({ name, photo, date, title, desc }));
        ...
        <div className="pl-box">
          <div className="modal-sideNav">
            <div className="sideContent">
              ...
              <div className="sideCard mb-15 text-center">
                ...
                <Link to="/" className="listing-btn red">
                  Go Back!
                </Link>
              </div>
            </div>
          ...
          <div className="pl-box-right">
            <form onSubmit={handleSubmit} className="pl-box-right-content">
              ...
              {showSuccessMessage && <div className="success-message">Hurray Feedback submitted successfully!</div>}
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setError((prevError) => ({ ...prevError, photo: false }));
                  }}
                />
                {error.photo && (
                  <span className="error-text">Photo is required</span>
                )}
              </div>
              <div className="form-group">
                <label>Date:</label>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setError((prevError) => ({ ...prevError, date: false }));
                  }}
                />
                {error.date && (
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  onChange={(e) => {
                    ...
                    setError((prevError) => ({ ...prevError, desc: false }));
                  }}
